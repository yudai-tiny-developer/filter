...
function main(common, settings, progress, data) {
    ...
    settings_list_1.appendChild(settings.createRow(data.button_label_short, common.button_label.short, 'short', data.short, true, undefined, 'subscriptions', input => chrome.storage.local.set({ button_label_short: input.value }), common.button_label.clear));
    ...
    settings_list_2.appendChild(settings.createRow(data.button_label_progress_watched, common.button_label.progress_watched, 'progress_watched', data.progress_watched, true, data.default_progress_watched ? data.default_progress_watched : false, 'progress', input => chrome.storage.local.set({ button_label_progress_watched: input.value })));
