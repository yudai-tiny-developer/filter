...
function main(common, settings, progress, data) {
    ...
    settings_list_1.appendChild(settings.createRow(data.button_label_post, common.button_label.post, 'post', data.post, false, data.default_post ? data.default_post : false, 'subscriptions', input => chrome.storage.local.set({ button_label_post: input.value }), common.button_label.clear));
    ...
    settings_list_5.appendChild(settings.createRow(common.button_label.hide_most_relevant, undefined, 'hide_most_relevant', data.hide_most_relevant, false));
