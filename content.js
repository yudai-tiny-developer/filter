...
function main(app, common, lang) {
    ...
    const collection_icon = '<svg style="width: 18px; height: 18px;" viewBox="0 0 24 24"><path d="M3 3.657v16.689a1 1 0 001.466.883L8 19.369V4.632l-3.534-1.86A1 1 0 003 3.657ZM14 7.79l-4-2.105v12.631l4-2.106V7.79ZM22 12l-6-3.157v6.315L22 12Z"></path></svg>';
